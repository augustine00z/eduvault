...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-20 md:py-28 px-6 md:px-0 overflow-hidden bg-[#fffaf6]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-yellow-100 via-transparent to-blue-100 rounded-full blur-3xl opacity-50" />
      ...
      >
        ...
        >
          Upload your study materials, past exam papers, and reports, then get ready for Soroban-backed publishing and access control.
        </motion.p>
        ...
        >
          ...
          >
            <Image src="/images/stellar.png" alt="Stellar icon" width={80} height={80} />
          </motion.div>
          ...
          >
            <Image src="/message-icon.png" alt="Message Icon" width={54} height={54} />
          </motion.div>
        </motion.div>
